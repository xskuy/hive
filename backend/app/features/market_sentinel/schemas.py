...
class ScanRunSummary(BaseModel):
    ...
    briefing_sector_patterns: list[str] | None = None
    briefing_standout_ticker: str | None = None
    briefing_noise_warning: str | None = None
...
class ScanBriefing(BaseModel):
    """Post-scan intelligence summary generated by the briefing agent."""
